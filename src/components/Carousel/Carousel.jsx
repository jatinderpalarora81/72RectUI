  ...
  const cards = [
    {
      ...
      text: "",
      image:
      // "https://dv5l4gwa2f8od.cloudfront.net/HomeSlider1.jpg"
      ...
      <Slider {...settings} ref={(slider) => setSlider(slider)}>
        {cards.map((card) => (
          <Box
           ...
           //  background='url(https://dv5l4gwa2f8od.cloudfront.net/HomeSlider5.jpg)center/cover no-repeat'
          ...
          >
            ...
            <Container size="container.lg" height="600px" m="auto" position="bottom" >
              <Stack
                spacing={6}
                w={"full"}
                maxW={"lg"}
                ...
                transform="translate(0, -50%)"
              >
                <Heading fontSize={{ base: "2xl", md: "4xl", lg: "5xl" }} color="">
                  {card.title}
                </Heading>
